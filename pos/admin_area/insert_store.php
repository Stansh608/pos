...
<i class="fa fa-dashboard" ></i> Dashboard / Add New Manufacturer
...
<i class="fa fa-money fa-fw"></i> New Manufacturer
...
<label class="col-md-3 control-label"> Company Slogan : </label>
...
<label class="col-md-3 control-label"> Company URL : </label>
...
<input type="submit" name="submit" value="Add new Manufacturer" class="btn btn-primary form-control">
...
echo "<script>alert('You have Successfully added a new Manufacturer')</script>";
