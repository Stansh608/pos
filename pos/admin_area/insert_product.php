...
$get_manufacturer = "select * from suppliers";
$run_manufacturer = mysqli_query($con,$get_manufacturer);
while($row_manufacturer= mysqli_fetch_array($run_manufacturer)){
$manufacturer_id = $row_manufacturer['supplier_id'];
$manufacturer_title = $row_manufacturer['supplier_name'];

echo "<option value='$manufacturer_id'>
$manufacturer_title
</option>";
$person=$manufacturer_title;
} 
