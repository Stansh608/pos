    ...
    <footer class="page-footer">
      ...
      <div class="footer-nav">
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            Head Office: KUTUS.<br>
            
          </address>
            <div class="phone">
              Telephone:
              <a class="phone__number" href="tel:0798602758">0798 602 758</a>
            </div>
            <div class="email">
              Email:
              <a href="mailto:stanleymunene@gmail.com" class="email__addr">stanleymunene@gmail.com</a>
            </div>
          </div>
      ...
      <div class="banners">
        ...
        <div class="banner-award">
				<span>All time best Sellers</span><br> 
			</div>

          <div class="banner-social">
            <a href="facebook.com" class="banner-social__link">
            <i class="icon-facebook"></i>
          </a>
            <a href="twitter.com" class="banner-social__link">
